        ...
        <div className="bg-gray-900 border border-gray-800 rounded-xl p-8">
          {loading ? (
            ...
            <div className="text-center space-y-4">
              ...
              <Link
                href="/"
                className="inline-block text-amber-400 hover:text-amber-300 text-sm font-semibold transition-colors"
              >
                Go to HeyDPE
              </Link>
            </div>
            ...
            <div className="text-center space-y-4">
              ...
              <h2 className="text-lg font-bold text-white tracking-tight">Connected!</h2>
              ...
              <Link
                href="/practice"
                className="inline-flex items-center justify-center w-full min-h-11 py-3 rounded-lg bg-amber-500 hover:bg-amber-400 text-gray-950 font-semibold text-[15px] transition-colors mt-4"
              >
                Start practicing
              </Link>
            </div>
            ...
            <div className="text-center space-y-4">
              <h2 className="text-lg font-bold text-white tracking-tight">Already accepted</h2>
              <p className="text-gray-400 text-sm">
            ...
            <div className="text-center space-y-5">
              ...
              {invite?.instructorCertType && (
                <span className="inline-block font-mono text-[11px] px-2 py-0.5 rounded border border-amber-400/30 bg-amber-400/10 text-amber-400 uppercase tracking-wider">
                  {invite.instructorCertType}
                </span>
              )}
              ...
              <button
                onClick={handleClaim}
                disabled={claiming}
                className="w-full min-h-11 py-3 rounded-lg bg-amber-500 hover:bg-amber-400 text-gray-950 font-semibold text-[15px] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
